...
#include "header/xyz_io.h"
#include "header/pca_estimate_normals.h"
#include "header/supervoxel_segmentation.h"
#include "header/distance_3d.h"
#include "header/kd_tree.h"
...
int main() {
    ...
    const std::string filename = "./test_data/test.xyz";
